...
class _YourCalWidgetState extends State<YourCalWidget> {
  double get _suggestedConsume => widget._tdee + totalExerciseCal;
  List<Color> get _gradientColors => _suggestedConsume < totalDietCal ? [appCardRed0Color, appCardRedColor,] : [appCardGreen0Color, appCardGreenColor,];
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 4),
                                      Text(
                                        _suggestedConsume.toStringAsFixed(1),
                                        style: TextStyle(
                                          color: Color.fromRGBO(
                                              24, 24, 24, 0.75),
                                          fontWeight: FontWeight.w700,
                                      ...
                                      SizedBox(height: 4),
                                      Text(
                                        totalDietCal.toStringAsFixed(1),
                                        style: TextStyle(
                                          color: Color.fromRGBO(
                                              24, 24, 24, 0.75),
                                          fontWeight: FontWeight.w700,
                                      ...
                                      children: [
                                        ...
                                        Text('食物攝取',
                                            style: TextStyle(
                                                ...
                                                fontSize: 12)),
                                        SizedBox(height: 3),
                                        Text(totalDietCal.toStringAsFixed(1) + '千卡',
                                            style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 12)),
                                      ],
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 3),
                                        Text(
                                            totalExerciseCal.toStringAsFixed(1) +
                                                '千卡',
                                            style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 12)),
